...
func Example_map() {
	...
	arrmap := map[[2]int]int{
		[2]int{1, 2}: 8,
		[2]int{3, 5}: 4,
	}
	Display("arrmap", arrmap)
	...
	scores := map[Person]int{
		Person{name: "alice", age: 31}:   80,
		Person{name: "charlie", age: 34}: 75,
	}
	...
	// Output:
	// Display ages (map[string]int):
	// ages["alice"] = 31
	// ages["charlie"] = 34
	// Display arrmap (map[[2]int]int):
	// arrmap[
	// 	[0] = 1
	// 	[1] = 2
	// ] = 8
	...
	// 	[1] = 5
	// ] = 4
	// Display scores (map[display.Person]int):
	// scores[
	// 	name = "alice"
	// 	age = 31
	// ] = 80
